...
export function getEventsByDate(): Record<string, EventRow[]> {
  return {
    ...
    "Jul 5, Saturday": eventRows.slice(6, 9),
  };
}

// Past events data (completed events linked to routes)
export const pastEventRows: EventRow[] = [
  {
    id: 101,
    image: "https://images.unsplash.com/photo-1551632811-561732d1e306?w=600&h=400&fit=crop",
    time: "6:30",
    duration: "6 hours",
    title: "Carrauntoohil winter summit",
    organizer: "Jack",
    organizerAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
    departureLocation: "Dublin Heuston Station",
    transportMethod: "Train",
  ...
  },
  {
    ...
    time: "9:30",
    duration: "3 hours",
    title: "Bray to Greystones autumn walk",
    organizer: "Sinead",
    organizerAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop&crop=face",
    departureLocation: "Bray DART Station",
    transportMethod: "DART",
    activity: "Hiking",
    difficulty: "T1",
  ...
  },
  {
    ...
    time: "7:00",
    duration: "5 hours",
    title: "Glendalough autumn colors",
    organizer: "John",
    organizerAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
    departureLocation: "Dublin",
    transportMethod: "Bus",
  ...
  },
  {
    ...
    time: "8:30",
    duration: "4 hours",
    title: "Spinc ridge sunrise hike",
    organizer: "Lisa",
    organizerAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop&crop=face",
    departureLocation: "Dublin Connolly Station",
    transportMethod: "Bus",
  ...
  },
  {
    ...
    time: "9:00",
    duration: "5 hours",
    title: "Glendalough winter solstice walk",
    organizer: "Emma",
    organizerAvatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
    departureLocation: "Glendalough Visitor Centre",
    transportMethod: "Carpool",
    activity: "Hiking",
    difficulty: "T2",
    distance: "12km",
    elevation: "420m",
    totalHeight: "420m gain",
    attendees: 20,
    availableSpots: 0,
    attendeeAvatars: [
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&crop=face",
